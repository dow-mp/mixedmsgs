...
function randomPhrase() {
    ...
    document.getElementById("msg").innerHTML = phrases[p];
    document.getElementById("msgButton").removeEventListener("click", randomPhrase);
};

document.getElementById("msgButton").addEventListener("click", randomPhrase);